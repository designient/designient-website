...
export function HyderabadCityPageContent() {
  return (
    <>
      ...
      <PageHero size="tall" align="center">
          <div className="max-w-4xl mx-auto w-full">
            ...
            <motion.div
              ...
              <span className="font-body text-sm" style={{ color: 'var(--color-primary)' }}>UI/UX Design Course in Hyderabad</span>
            </motion.div>
      ...
      {/* Hyderabad – core mentoring team */}
      <section className="py-16 md:py-20" style={{ backgroundColor: 'var(--bg-peach)' }} aria-labelledby="hyderabad-intro-heading">
        <div className="max-w-container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2
              id="hyderabad-intro-heading"
              className="font-display font-bold mb-6"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <motion.div
              ...
              <p
                className="font-body text-lg leading-relaxed mb-6"
                style={{ color: 'var(--text-secondary)', fontSize: 'clamp(1rem, 1.8vw, 1.25rem)' }}>
                This course page is powered by Designient's <Link href="/ui-ux-design-pro" className="font-semibold underline" style={{ color: 'var(--color-primary)' }}>UI/UX Design Pro program</Link> — a 3-month hands-on course focused on practical skills, design thinking, and portfolio development.
              </p>
            </motion.div>
          </div>
        </div>
