...
export function OutcomeTransformationSection({ 
 ...
 return (
 <section id="outcomes" className="py-20 md:py-28" style={{ backgroundColor: 'var(--bg-card)' }}>
 ...
 className="flex items-start gap-4 p-6 bg-card rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
 <CheckCircle className="w-6 h-6 flex-shrink-0 mt-0.5" style={{ color: 'var(--color-primary)' }} />
 <span className="font-body leading-relaxed" style={{ color: 'var(--text-secondary)', fontSize: 'clamp(0.9375rem, 1.5vw, 1.0625rem)' }}>
 {outcome}
 </span>
 </motion.div>
 ))}
