...
export function PromptEngineeringRetiredContent() {
  return (
    <section className="pt-24 pb-16 md:pt-32 md:pb-24" style={{ backgroundColor: 'var(--bg-card)' }}>
      <div className="max-w-container mx-auto px-4 md:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p
            ...
            <a href="mailto:hello@designient.com?subject=Prompt%20Engineering%20Mastery%20Refund%20Request" className="font-semibold underline hover:no-underline" style={{ color: 'var(--color-primary)' }}>
          ...
          <p className="font-body text-sm" style={{ color: 'var(--text-muted)' }}>
            Questions? Email{' '}
            <a href="mailto:hello@designient.com" className="underline hover:no-underline" style={{ color: 'var(--color-primary)' }}>
              hello@designient.com
            </a>{' '}
            or{' '}
            <Link href="/contact-us" className="underline hover:no-underline font-semibold" style={{ color: 'var(--color-primary)' }}>
              contact us
            </Link>
            .
          </p>
