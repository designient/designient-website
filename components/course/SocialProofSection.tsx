...
export function SocialProofSection() {
 ...
 return (
 <section className="py-12 md:py-16" style={{ backgroundColor: 'var(--bg-peach)' }}>
 ...
 <div className="inline-flex items-center justify-center w-12 h-12 rounded-lg mb-3 accent-icon-box" style={{ backgroundColor: 'var(--color-primary)' }}>
 <Icon className="w-6 h-6" style={{ color: 'var(--text-on-accent)' }} />
 </div>
 <p
