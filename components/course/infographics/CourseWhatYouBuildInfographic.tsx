...
export type BuildProgressConfig = {
  startLabel: string
  endLabel: string
  pathLabel: string
...
type CourseWhatYouBuildInfographicProps = {
...
const DEFAULT_PROGRESS: BuildProgressConfig = {
  startLabel: 'Week 1',
  endLabel: 'Week 10',
  pathLabel: '10-week build path',
  stats: [
    { value: '5', label: 'Portfolio modules' },
    { value: '10', label: 'Weeks to ship' },
    { value: '1', label: 'Job-ready portfolio' },
  ],
  footerMessage: 'Every artefact below is built during the course - not after it.',
}

function AnimatedProgressBar({ config }: { config: BuildProgressConfig }) {
...
export function CourseWhatYouBuildInfographic({ modules, progress = DEFAULT_PROGRESS }: CourseWhatYouBuildInfographicProps) {
  return (
    <div className="relative">
      <AnimatedProgressBar config={progress} />
