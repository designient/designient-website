...
type CourseStackInfographicProps = {
  ...
  return (
    <div ref={ref} className="mb-8">
      ...
      <p className="font-body text-xs text-center mt-2 font-semibold" style={{ color: 'var(--color-forest)' }}>
        You save ~{percent}% vs buying everything separately
      </p>
    </div>
  )
}

export function CourseStackInfographic({ bonuses, valueRows, emi, internationalUsdNote, savingsPercent = 85 }: CourseStackInfographicProps & { savingsPercent?: number }) {
    ...
    <div className="space-y-16 md:space-y-20">
      ...
      <section>
        ...
        <div className="max-w-3xl mx-auto">
          <SavingsBar percent={savingsPercent} />
