...
export function QuickOfferHighlights({ items, title = "What This Bootcamp Includes (Premium Value Stack)" }: QuickOfferHighlightsProps) {
  return (
    <section id="what-this-includes" className="py-20 md:py-28" style={{ backgroundColor: 'var(--bg-card)' }}>
      <div className="max-w-container mx-auto px-4 md:px-6 lg:px-8">
        <motion.div
          ...
          <p className="font-body text-base md:text-lg max-w-3xl mx-auto leading-relaxed mt-4" style={{ color: 'var(--text-muted)' }}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 max-w-6xl mx-auto">
          {items.map((item, index) => (
            ...
            >
              <CheckCircle className="w-6 h-6 flex-shrink-0 mt-0.5" style={{ color: 'var(--color-primary)' }} aria-hidden="true" />
