...
const whyJoinItems = [
  ...
  {
    icon: BookOpen,
    title: 'Creative curriculum design',
    description: 'Shape how design is taught and learned'
  },
  {
    icon: Zap,
    title: 'Creative freedom and autonomy',
    description: 'Design learning experiences your way'
  },
  {
    icon: Heart,
    title: 'Continuous learning culture',
    description: 'Stay ahead of design trends and education'
  }
]

export function CurriculumDesignerContent() {
  return (
    <>
      {/* Hero Section */}
      <section 
        ...
        <div className="max-w-container mx-auto px-4 md:px-6 lg:px-8 w-full">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-2 mb-6 text-sm" style={{ color: '#6B7280' }}>
              ...
              <span>/</span>
              <span>Content & Curriculum Designer</span>
            </div>
            ...
            <motion.h1
              ...
              Content & Curriculum Designer Job – Careers at Designient
            </motion.h1>
            ...
            <motion.p
              ...
              Create, refine, and improve UI/UX learning content and curriculum structure.
            </motion.p>
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              <p
                ...
                We need someone who can translate industry expertise into effective learning experiences. You&apos;ll create course content, design learning modules, and ensure our curriculum stays relevant and practical.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      {/* Application Form */}
      <CareerApplicationForm roleName="Content & Curriculum Specialist – UI/UX" roleId="curriculum-specialist" />
          ...
          <div className="max-w-3xl mx-auto text-center text-white">
            <motion.div
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a
                  href="mailto:careers@designient.com?subject=Application for Content & Curriculum Specialist Position"
