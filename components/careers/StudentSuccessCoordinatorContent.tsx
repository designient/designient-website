...
export function StudentSuccessCoordinatorContent() {
  return (
    <>
      {/* Hero Section */}
      <section 
        ...
        <div className="max-w-container mx-auto px-4 md:px-6 lg:px-8 w-full">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-2 mb-6 text-sm" style={{ color: '#6B7280' }}>
              ...
              <span>/</span>
              <span>Community & Student Success Coordinator</span>
            </div>
            ...
            <motion.h1
              ...
              Community & Student Success Coordinator Job – Careers at Designient
            </motion.h1>
            ...
            <motion.p
              ...
              Support students throughout their learning journey and help build a strong design community.
            </motion.p>
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              <p
                ...
                As a Student Success Coordinator at Designient, you&apos;ll be the bridge between students and their learning goals. You&apos;ll help students stay motivated, resolve challenges, and build a supportive community of designers.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      {/* Application Form */}
      <CareerApplicationForm roleName="Community & Student Success Coordinator" roleId="student-success" />
          ...
          <div className="max-w-3xl mx-auto text-center text-white">
            <motion.div
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a
                  href="mailto:careers@designient.com?subject=Application for Community & Student Success Coordinator Position"
