    ...
    <section
      ...
      <div className="max-w-container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <motion.div
          ...
          <h3
            className="font-display tracking-tight text-center mb-12"
            style={{
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
            {recentPlacements.map((placement, index) =>
              <motion.div
                ...
                className="group relative p-5 sm:p-6 rounded-2xl border border-strong overflow-hidden transition-all duration-300 hover:shadow-card-hover hover:-translate-y-1"
                style={{
                ...
                <div className="relative z-10">
                  {/* Avatar placeholder */}
                  <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full mb-4 flex items-center justify-center font-display text-xl sm:text-2xl font-bold" style={{ backgroundColor: 'var(--bg-section-green)', color: 'var(--color-forest)' }}>
