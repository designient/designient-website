...
const faqs = [
 ...
 answer:
 'Yes. Perplexity, Claude, Figma, and Bolt are embedded in the Design Track curriculum at every level - not as a separate module, but as part of the working design process from day one.',
 },
 {
