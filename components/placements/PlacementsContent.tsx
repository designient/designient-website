...
const faqs = [
 ...
 answer: 'While we cannot guarantee employment, we provide full placement support including portfolio building, interview coaching, and job referrals. Our 95% placement rate reflects the effectiveness of our support system when students actively engage with the process.'
 },
 {
...
export function PlacementsContent() {
 ...
 <p
 className="font-body text-xs text-center max-w-3xl mx-auto mt-8 leading-relaxed"
 style={{ color: 'var(--text-muted)' }}
 >
