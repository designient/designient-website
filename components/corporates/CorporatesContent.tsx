...
export function CorporatesContent() {
 ...
 description: 'Practical AI integration and modern workflows that prepare teams for tomorrow',
 },
 {
 ...
 <p className="font-body text-lg max-w-3xl mx-auto" style={{ color: 'var(--text-secondary)' }}>
 End-to-end solutions tailored to your team&apos;s needs and business objectives
 </p>
 </motion.div>
