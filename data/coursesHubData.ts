...
export const aiTrackComparison: ComparisonRow[] = [
 ...
 { label: 'Primary tools', valuesInr: ['Zapier, n8n, Make, Airtable, ManyChat, Relevance AI', 'Perplexity, Claude, Figma, Bolt'], valuesUsd: ['Zapier, n8n, Make, Airtable, ManyChat, Relevance AI', 'Perplexity, Claude, Figma, Bolt'] },
