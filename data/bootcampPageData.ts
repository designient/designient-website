...
export const bootcampTools = [
 ...
 { name: 'Figma', description: 'Journey mapping and IA diagramming on Saturday morning. Full visual design Saturday afternoon. The primary design tool.' },
