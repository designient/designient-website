...
export const aiProductPatternComparison = {
  ...
  rows: [
    ...
    { feature: 'Toolchain', pro: 'Perplexity, Claude, FigJam, Figma, Bolt', others: 'Figma only' },
  ],
}
...
export const aiProductShipArtifacts = [
  {
    ...
    supporting: 'Supporting artefacts: teardown doc, trust architecture diagram (FigJam), redesigned Figma screens.',
  },
  {
    ...
    supporting:
      'Supporting artefacts: AI behaviour spec, FigJam decision tree, Figma file (12+ screens), Bolt/v0 prototype, prompt chain documentation, written case study.',
  },
]
...
export const aiProductCurriculumWeeks = [
  ...
  },
  {
    ...
    sessions: [
      ...
      {
        title: 'Session 4: FigJam AI — Mapping AI Decision Architecture',
...
export const aiProductTools = [
  ...
  { name: 'FigJam AI', description: 'Week 2. Trust architecture diagrams, AI decision trees, human-in-the-loop flow mapping.' },
  { name: 'Figma', description: 'Weeks 3, 4, and 5. All 8 AI states, component library, audit product redesign, original feature design across all states.' },
