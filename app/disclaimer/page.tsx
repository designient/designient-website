        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16">
          ...
          <div className="mb-12">
            ...
            <p className="font-body leading-relaxed" style={{ color: 'var(--text-secondary)', fontSize: '1.125rem' }}>
              This Disclaimer should be read in conjunction with our <Link href="/terms-and-conditions" className="text-[var(--color-primary)] underline">Terms and Conditions</Link>, <Link href="/privacy-policy" className="text-[var(--color-primary)] underline">Privacy Policy</Link>, and <Link href="/cancellation-refund-policy" className="text-[var(--color-primary)] underline">Cancellation & Refund Policy</Link>.
            </p>
          </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-red-50 border-l-4 border-red-400 p-4">
                <p className="font-body font-semibold mb-3" style={{ color: 'var(--text-primary)' }}>Important Notice:</p>
              ...
              <p className="font-body leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
                While we provide placement assistance and career support (as outlined in our <Link href="/terms-and-conditions" className="text-[var(--color-primary)] underline">Terms and Conditions</Link>), we do not guarantee job placement or employment outcomes.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-4">
                <p className="font-body font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>Important:</p>
                <p className="font-body leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          ...
          <div className="mt-12 pt-8 border-t-2" style={{ borderColor: 'var(--border-default)' }}>
            <p className="font-body leading-relaxed mb-4" style={{ color: 'var(--text-secondary)', fontSize: '1.125rem' }}>
              This Disclaimer is part of and should be read together with our <Link href="/terms-and-conditions" className="text-[var(--color-primary)] underline">Terms and Conditions</Link>, <Link href="/privacy-policy" className="text-[var(--color-primary)] underline">Privacy Policy</Link>, and <Link href="/cancellation-refund-policy" className="text-[var(--color-primary)] underline">Cancellation & Refund Policy</Link>. In case of any conflict between this Disclaimer and other policy documents, the Terms and Conditions shall prevail.
            </p>
            <p className="font-body leading-relaxed" style={{ color: 'var(--text-secondary)', fontSize: '1.125rem' }}>
