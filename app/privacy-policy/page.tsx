        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16">
          ...
          <div className="mb-12">
            ...
            <p className="font-body leading-relaxed" style={{ color: 'var(--text-secondary)', fontSize: '1.125rem' }}>
              This Privacy Policy should be read in conjunction with our <Link href="/terms-and-conditions" className="text-[var(--color-primary)] underline">Terms and Conditions</Link> and <Link href="/cancellation-refund-policy" className="text-[var(--color-primary)] underline">Cancellation & Refund Policy</Link>. By using our services, you consent to the data practices described in this policy.
            </p>
          </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <p className="font-body leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
                To exercise these rights, please contact us at <Link href="mailto:hello@designient.com" className="text-[var(--color-primary)] underline">hello@designient.com</Link>. We will respond to your request within a reasonable timeframe.
              </p>
            </div>
          </section>
