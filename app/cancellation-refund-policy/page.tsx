        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16">
          ...
          <div className="mb-12">
            ...
            <p className="font-body leading-relaxed" style={{ color: 'var(--text-secondary)', fontSize: '1.125rem' }}>
              This policy should be read in conjunction with our <Link href="/terms-and-conditions" className="text-[var(--color-primary)] underline">Terms and Conditions</Link>, which govern all aspects of your enrollment and use of our services.
            </p>
          </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-red-50 border-l-4 border-red-400 p-4 my-4">
                <p className="font-body font-semibold mb-3" style={{ color: 'var(--text-primary)' }}>No Refunds Will Be Provided For:</p>
                <ul className="list-disc pl-6 space-y-2" style={{ color: 'var(--text-secondary)' }}>
          ...
          <div className="mt-12 pt-8 border-t-2" style={{ borderColor: 'var(--border-default)' }}>
            <p className="font-body leading-relaxed mb-4" style={{ color: 'var(--text-secondary)', fontSize: '1.125rem' }}>
              This Cancellation & Refund Policy is part of and should be read together with our <Link href="/terms-and-conditions" className="text-[var(--color-primary)] underline">Terms and Conditions</Link>. In case of any conflict between this policy and the Terms and Conditions, the Terms and Conditions shall prevail.
            </p>
            <p className="font-body leading-relaxed" style={{ color: 'var(--text-secondary)', fontSize: '1.125rem' }}>
